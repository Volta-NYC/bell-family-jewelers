    ...
    <div>
      <section className="bg-[#191714] text-[#fbf5e8]">
        <div className="site-container grid min-h-[calc(100svh-130px)] gap-10 py-12 lg:grid-cols-[0.92fr_1.08fr] lg:items-center lg:py-16">
          ...
          <div className="scroll-reveal relative min-h-[440px] lg:min-h-[620px]">
            <div className="absolute right-0 top-0 h-[72%] w-[74%] overflow-hidden border border-[#5c5145] bg-[#f7f1e8] luxury-shadow">
              <Image
                ...
                className="scroll-image object-contain p-8"
              />
            </div>
            <div className="absolute bottom-8 left-0 h-[52%] w-[56%] overflow-hidden border border-[#5c5145] bg-[#f7f1e8] shadow-[0_24px_70px_rgb(0_0_0_/_0.35)]">
              <Image
                ...
                className="scroll-image object-contain p-6"
              />
            </div>
      ...
      <section className="site-container section-rule py-14 sm:py-20">
        <div className="scroll-reveal mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
      ...
      <section className="section-rule bg-[#efe5d6] py-14 sm:py-20">
        <div className="site-container">
          ...
          <div className="scroll-grid grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <section className="site-container section-rule grid gap-8 py-14 sm:py-20 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
        ...
        <div className="scroll-grid grid gap-4 sm:grid-cols-2">
          {services.map((service) => (
            <article key={service.slug} className="surface-card scroll-card border border-[#dfd4c4] bg-[#fbf8f2] p-6">
      ...
      <section className="section-rule bg-[#191714] py-14 text-[#fbf5e8] sm:py-20">
