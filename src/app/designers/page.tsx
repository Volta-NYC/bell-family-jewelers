    ...
    <div className="site-container py-12 sm:py-16">
      ...
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {business.designers.map((designer) => {
          ...
          return (
            <Link key={designer.slug} href={`/designers/${designer.slug}`} className="group border border-[#dfd4c4] bg-[#fbf8f2] p-6 transition-all hover:-translate-y-1 hover:border-[#c9a45f]">
