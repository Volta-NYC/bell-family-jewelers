    ...
    <div>
      <section className="bg-[#191714] text-[#fbf5e8]">
        <div className="site-container grid gap-8 py-12 sm:py-16 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          ...
          {heroImage && (
            <div className="relative aspect-[16/10] border border-[#5c5145] bg-[#f7f1e8]">
              <Image src={heroImage} alt={collection.name} fill sizes="(min-width: 1024px) 48vw, 100vw" className="object-contain p-10" priority />
            </div>
          )}
        </div>
      </section>
